...
folderPath_brush = "Header"
myList = os.listdir(folderPath_brush)  # getting all the images used in code
# print(myList)
for imPath in myList:  # reading all the images from the folder
    image = cv2.imread(f'{folderPath_brush}/{imPath}')
...
while True:
    ...
    img = cv2.resize(img, (400, 300))  # Resize image
